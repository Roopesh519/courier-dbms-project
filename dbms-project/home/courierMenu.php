    ...
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin: auto; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center;background-color:cyan; font-family:Berlin Sans FB; width: 140px; height: 60px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                ...
                <tr>
                    ...
                    <td>Payment Id:</td>
                    <td><input type="number" name="billno" placeholder="enter billno." required></td>
                </tr>
                <tr>
